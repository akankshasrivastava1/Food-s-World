...
<html lang="en">
  <head>
    ...
    <title>Home's Magic|Orders</title>
...
<nav class="navbar navbar-default navbar-fixed-top" id="up-nav">
      ...
      <div class="navbar-header">
              ...
              <div class="logo_heading">
                <a href="index.php" style="float:left;">
                  <div class="navbar-header heading"><h2>Food's Magic</h2></div>
                </a>
              </div>
            </div>
    ...
    <div class="collapse navbar-collapse" id="up_nav">
        ...
        <ul class="nav navbar-nav navbar-right menu_list">
          ...
          <li class="active active_now"><a href="mycart.php?rest_id_url2=<?php echo $_GET['rest_id_url2']; ?>"><i class="fa fa-cutlery" aria-hidden="true"></i>&nbsp;My plate<span class="sr-only">(current)</span></a></li>
        </ul>
        </div>
      </div>
</nav>
...
<h1 class="text-center"><i class="fa fa-check" aria-hidden="true"></i>YOU HAVE SUCCESSFULLY PLACED THE ORDER.</h1>
<div style="width:200px;margin:auto;"><input class='btn btn-default text-center' type="button" onclick="window.open('index.php','_self')" value='Go to Home'></div>
</div>
