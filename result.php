...
<html lang="en">
  <head>
    ...
    <title>Food'S MAGIC|RESULTS</title>
    ...
    <script src="https://use.fontawesome.com/3a56f618e9.js"></script>
    ...
    <div class="container-fluid">
      <div class="navbar-header">
              ...
              <div class="logo_heading">
                <a href="IEEE.html" style="float:left;">
        ...
        <ul class="nav navbar-nav navbar-right menu_list">
          <li class="active active_now"><a href="#">Home <span class="sr-only">(current)</span></a></li>
              <li class="dropdown">
